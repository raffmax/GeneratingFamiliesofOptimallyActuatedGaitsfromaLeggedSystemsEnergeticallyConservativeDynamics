% *************************************************************************
%
% function [f, v, c] = GetLowerActuatorPatch()
% 
% Returns faces, vertices, and color-values (one per face) that represent a
% patch of the lower actuator of a prismatic leg.
%
% - The actuator is positioned at [0, 0, 0]
...
%
function [f, v, c] = GetLowerActuatorPatch(colors)
%     % Actuator is composed as a cylinder
...
%     c(18:20:400, :)=repmat([0 0 0], 20, 1);
    [x, y] = cylinder([0; ones(40,1)*0.095; 0],20);
    z = repmat([.03, .03, linspace(.03, 0, 38),0,0]',1,21);

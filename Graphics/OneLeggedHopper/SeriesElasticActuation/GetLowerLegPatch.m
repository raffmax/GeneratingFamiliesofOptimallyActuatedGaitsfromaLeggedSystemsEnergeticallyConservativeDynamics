...
%
function [f,v,c] = GetLowerLegPatch(colors,epsilon)
    ...
    [x, y] = cylinder([0.031*epsilon, 0.031, 0.1-0.069*(cos((0:1:10)/10*pi/2)), 0.1 , 0.1, 0.1, 0.031*epsilon, 0.031*epsilon, 0.031*epsilon, 0.031*epsilon, 0]);
    z = repmat([0; 0.1; 0.1+0.05*(sin((0:1:10)/10*pi/2))'; 0.15; 0.16; 0.16; 0.16; 0.16; 0.7; 0.7; 0.7], 1, 21);
